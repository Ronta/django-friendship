    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(related_name='friendship_requests_sent',
                                                to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('to_user',
                 models.ForeignKey(related_name='friendship_requests_received', to=settings.AUTH_USER_MODEL,
                                   on_delete=models.CASCADE)),
            ],
            options={
